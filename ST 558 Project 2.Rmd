...
# Data Exploration
```{r data_exploration, warning=FALSE, include=TRUE, echo=TRUE}
...
instate_earning <- ggplot(earnings_data) +
  ...
  labs(x="In-State Tuition", y="Median Earnings (10 yrs after entry)", title="Median Earnings vs In-State Tuition") +
  theme_minimal() +
  theme(plot.title=element_text(hjust=0.5),
        plot.subtitle=element_text(hjust=0.5))  
...
outstate_earning <-  ggplot(earnings_data) +
  ...
  geom_point(shape="circle", size=2, colour="#112446") +
  geom_smooth(span=0.75) +
  labs(x="Out-of-State Tuition", y="Median Earnings (10 yrs after entry)", title="Median Earnings vs Out-of-State Tuition") +
  theme_minimal() +
  theme(plot.title=element_text(hjust=0.5),
        plot.subtitle=element_text(hjust=0.5))  
...
```{r main_function, warning=FALSE, include=TRUE, echo=TRUE}
main <- function() {
  key = params$key
  state = params$state
